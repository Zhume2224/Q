...
- should be able to confirm *at least one* film is from a specified year - true case - 1/2
- should be able to confirm *none of* the films are from a specified year - false case - 2/2
